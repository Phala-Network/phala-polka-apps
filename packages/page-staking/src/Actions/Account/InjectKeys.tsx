        ...
        <Modal.Columns>
          <Modal.Column>
            ...
            <article className='warning'>
              <div><Icon name='warning sign' />{t<string>('This operation will submit the seed via an RPC call. Do not perform this operation on a public RPC node, but ensure that the node is local, connected to your Gatekeeper and secure.')}</div>
            </article>
          </Modal.Column>
          <Modal.Column>
